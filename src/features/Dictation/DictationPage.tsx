...
export default function DictationPage() {
  ...
  // TODO: Comment pageCount vì được tính từ API response
  ...
  const fetchData = async (pageNum = 1, limit = rowsPerPage) => {
    try {
      ...
      setRows(res.items || []);
      setPage(res.page);
      // TODO: setPageCount đã được comment vì không dùng
