...
const SectionGuide = forwardRef<HTMLElement, SectionGuideProps>(
  ({ onOpenRegister }, ref) => (
    <section
      ref={ref}
    ...
    >
      <motion.div
        ...
        viewport={{ amount: 0.2, once: true }} // quan trọng để tránh kẹt scroll
      >
        <Typography variant="h3" component="h2" className="font-bold text-indigo-700 !mb-4">
          Hướng dẫn tham gia
        </Typography>
